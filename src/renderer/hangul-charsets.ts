// Hangul charsets for the ASCII layer (fork atb-post).
// KS X 1001 = the 2,350 syllables of the standard set (every syllable that
// encodes as two bytes in EUC-KR); full = all 11,172 modern syllables
// (U+AC00..U+D7A3), generated. Compat jamo = U+3131..U+3163 (51 letters).

export const HANGUL_JAMO =
  " ㄱㄲㄳㄴㄵㄶㄷㄸㄹㄺㄻㄼㄽㄾㄿㅀㅁㅂㅃㅄㅅㅆㅇㅈㅉㅊㅋㅌㅍㅎㅏㅐㅑㅒㅓㅔㅕㅖㅗㅘㅙㅚㅛㅜㅝㅞㅟㅠㅡㅢㅣ"

export const HANGUL_KSX1001 =
  " " +
...
export function buildHangulFull(): string {
  let out = " "
