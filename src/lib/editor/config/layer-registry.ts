...
const paletteMapParams = [
  {
    defaultValue: "#000000",
    description:
      "Below the black point. Keep it pure black so the pass keys out under Screen/Lighten in the NLE.",
    group: "Palette",
    key: "voidColor",
    label: "Void",
    type: "color",
  ...
  {
    defaultValue: "#FFB4C8",
    description: "Constant across temperature.",
    group: "Palette",
    key: "topColor",
    label: "Top (white)",
    type: "color",
  ...
  },
  {
    defaultValue: 0,
    description:
      "0 = warm pole (red/magenta), 1 = cold pole (blue/cyan). Interpolated in OKLab so the midpoint is clean violet. Keyframe it or link it to a stem.",
    group: "Temperature",
    key: "temperature",
    label: "Temperature",
    max: 1,
