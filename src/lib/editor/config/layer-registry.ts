...
const paletteMapParams = [
  ...
  {
    defaultValue: 0.12,
    description: "Pulls the void toward the shadow colour.",
    group: "Signal",
    key: "voidBlend",
    label: "Void Blend",
    max: 1,
  ...
  {
    defaultValue: 0.35,
    description: "How far the mids breathe toward the shadow colour.",
    group: "Drift",
    key: "driftDepth",
    label: "Drift Depth",
    max: 1,
  ...
  {
    defaultValue: 6,
    description: "Seconds per warm→cold→warm cycle.",
    group: "Drift",
    key: "driftPeriod",
    label: "Drift Period",
    max: 60,
